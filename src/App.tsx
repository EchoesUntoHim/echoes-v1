  ...
  const generateYoutubeMetadata = async () => {
    ...
    try {
      ...
      const prompt = `
        ...
        {
          "title": "2026년 유튜브 알고리즘이 선호하는, 클릭률(CTR)을 극대화한 강력한 제목",
          "description": "다음 형식을 엄격히 지켜주세요:\\n1. 시청자의 검색 의도를 반영한 감성적이고 깊이 있는 곡 설명 (3-4줄)\\n2. 줄바꿈 후 '구글 검색 및 유튜브 추천 알고리즘 최적화 문구' 포함\\n3. 줄바꿈 후 '구독, 좋아요, 알림 설정은 큰 힘이 됩니다.' 문구 포함\\n4. 줄바꿈 후 고정 노출용 해시태그 3-5개 (예: #CCM #찬양 #감성음악)\\n\\n모든 문장은 자연스러운 줄바꿈(\\n)을 포함하여 최상의 가독성을 유지하세요.",
          "tags": "실제 검색량이 높은 핵심 키워드 10-15개를 쉼표로 구분 (예: 은혜로운찬양, 가사있는찬양, 새벽기도음악, 인기CCM, 2026추천찬양 등)"
        }
      `;
    ...
    <div className="flex h-screen bg-background overflow-hidden flex-col md:flex-row">
      ...
      <div className="md:hidden flex items-center justify-between p-4 border-b border-white/5 bg-background z-30">
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[8px] text-primary/50 font-bold mt-0.5 tracking-widest uppercase">v1.4.5</span>
          </div>
        </div>
      ...
      <aside className={cn(
        ...
        >
          ...
          <div className="flex flex-col">
            <span className="text-xl font-bold tracking-tighter group-hover:text-primary transition-colors leading-none">Echoes Unto Him</span>
            <span className="text-[10px] text-primary/50 font-bold mt-1 tracking-widest uppercase">v1.4.5</span>
          </div>
        </div>
