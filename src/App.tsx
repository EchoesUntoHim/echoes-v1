  ...
  const generateYoutubeMetadata = async () => {
    ...
    try {
      ...
      const prompt = `
        ...
        {
          "title": "2026년 유튜브 알고리즘 최적화 및 높은 클릭률을 유발하는 제목",
          "description": "다음 템플릿의 문체와 줄바꿈 형식을 반드시 엄격하게 따라주세요:\\n\\n할렐루야! 오늘 함께 나눌 찬양은 '[한글제목] _ [영문제목]' 입니다. 🌿\\n\\n[곡의 주제와 어울리는 은혜롭고 감성적인 설명 2-3줄]\\n가사를 묵상하며 주님의 크신 사랑과 은혜를 깊이 경험하는 귀한 시간 되시길 기도합니다.\\n\\n항상 주님 안에서 승리하시고, 오늘 하루도 말씀과 기도로 나아가는 복된 하루 되세요! 🙏\\n\\n🔔 구독과 좋아요는 은혜로운 찬양을 나누는 데 큰 힘이 됩니다. 💖\\n\\n#CCM #찬양 #예배 #은혜 #위로 #기도 #기독교 #교회 #찬양추천 #플레이리스트",
          "tags": "은혜로운찬양, 가사있는찬양, 새벽기도음악, 인기CCM, 2026추천찬양, ${workflow.params.koreanTitle}, 찬양플레이리스트"
        }
      `;
