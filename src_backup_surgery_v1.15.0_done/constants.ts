...
export const DEFAULT_IMAGE_ENGINE = 'imagen-4.0-fast-generate-001';
...
export const IMAGE_ENGINES = [
  { value: 'imagen-4.0-fast-generate-001', label: 'Imagen 4.0 Fast (가성비 최우선 / ~26.06.30)', type: 'free' },
  { value: 'gemini-3.1-flash-image-001', label: 'Gemini 3.1 Flash Image (종료 미정)', type: 'free' }
];

export const MUSIC_ENGINES = []; // 음악 엔진 목록 비움
...
export const CCM_MOODS = [
  ...
  '깊은 임재의', '거룩한', '영광스러운', '회복의', '기름부으심이있는', '평화의', '강력한선포의', '순종하는', '동행하는', '사모하는'
];

export const CCM_GENRE_DESCRIPTIONS: Record<string, string> = {
  '워십': '회중과 함께 부르는 경배와 찬양 스타일',
  '모던워십': '세련된 밴드 사운드 기반의 현대적 찬양',
  '전통찬송가': '4부 합창 중심의 클래식하고 엄숙한 스타일',
  '가스펠': '소울풀하고 리드미컬한 흑인 영성 음악 스타일',
  'CCM팝': '대중적인 멜로디와 편곡의 현대 기독교 음악',
  '어쿠스틱워십': '통기타와 건반 위주의 담백하고 따뜻한 찬양',
  '합창': '풍성한 화음과 웅장한 합창단 사운드',
  '기타': '다양한 스타일의 기독교 음악'
};
...
export const INSTRUMENT_CATEGORIES: Record<string, string[]> = {
  '건반악기': ['피아노', '신디사이저', '오르간', '해먼드 오르간', '패드 신스'],
  '현악기': ['어쿠스틱 기타', '일렉트릭 기타', '베이스', '나일론 기타', '우쿨렐레', '바이올린', '비올라', '첼로', '콘트라베이스', '스트링 앙상블'],
  '관악기': ['플루트', '색소폰', '트럼펫', '호른', '백파이프'],
  '타악기': ['드럼', '퍼커션'],
  '국악기': ['가야금', '해금', '아쟁', '국악기'],
  '기타': ['오케스트라', '합창단', '아카펠라']
};

export const CCM_GENRE_RECOMMENDATIONS: Record<string, string[]> = {
  '워십': ['어쿠스틱 기타', '피아노', '드럼'],
  '모던워십': ['일렉트릭 기타', '신디사이저', '베이스'],
  '전통찬송가': ['피아노', '오케스트라', '해먼드 오르간'],
  '가스펠': ['해먼드 오르간', '피아노', '드럼'],
  'CCM팝': ['신디사이저', '일렉트릭 기타', '드럼'],
  '어쿠스틱워십': ['어쿠스틱 기타', '나일론 기타', '피아노'],
  '합창': ['오케스트라', '스트링 앙상블', '합창단'],
  '기타': ['피아노', '어쿠스틱 기타']
};
...
export const KOREAN_FONTS = [
  ...
  { value: "'JSArirang', cursive", label: '정선 아리랑체 (JS Arirang)' },
