          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              ...
              <button
                ...
                className={cn(
                  "w-full py-3 rounded-xl font-black text-lg transition-all flex items-center justify-center gap-2",
                  isGenerating 
                    ? "bg-primary/5 text-primary/40 border border-primary/10 cursor-wait" 
                    : "bg-primary/10 text-primary border border-primary/40 hover:bg-primary/20 shadow-[0_0_15px_rgba(0,255,163,0.1)]"
                )}
              >
                {isGenerating ? (
                  <>
