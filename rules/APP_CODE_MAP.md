...
- v1.12.23 (2024-04-27): [Art/Font/Sync] 수묵화 화풍 추가, 로컬 감성 폰트 통합, 버전 표시 및 코드맵 최종 동기화.
- **[L1, L18]**: `index.css` 내 로컬 폰트(`public/fonts/`) `@font-face` 주입 완료.
- **[L127, L239]**: `constants.ts` 내 화풍 드롭다운 수묵화 추가 완료.
- **[L294, L321, L340, L358]**: `constants.ts` 내 모든 폰트 리스트 로컬 파일 기반으로 정돈 및 3단계 카테고리화 완료.
- **[L3279]**: `App.tsx` 내 모바일 메뉴 버전 표기 `v1.12.23`으로 업데이트 완료.
- **[L24]**: `LandingPage.tsx` 내 버전 표기 `v1.12.23`으로 동기화 완료.
